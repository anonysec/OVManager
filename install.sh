...
banner() {
    ...
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}_____  _   ____  ___                                   ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}|  _  || | | |  \\/  |                                  ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}| | | || | | | .  . | __ _ _ __   __ _  __ _  ___ _ __ ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}| | | || | | | |\\/| |/ _\` | '_ \\\\ / _\` |/ _\` |/ _ \\\\ '__|${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}\\\\ \\\\_/ /\\\\ \\\\_/ / |  | | (_| | | | | (_| | (_| |  __/ |   ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD} \\\\___/  \\\\___/\\\\_|  |_/\\\\__,_|_| |_|\\\\__,_|\\\\__, |\\\\___|_|   ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}                                        __/ |          ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}                                       |___/           ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}                                                           ${BLUE}|${R}"
