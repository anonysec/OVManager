...
banner() {
    ...
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}____ _    ____  ___                                    ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}  / __ \\ |  / /  |/  /___ _____  ____ _____ ____  _____${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD} / / / / | / / /|_/ / __ \` / __ \\/ __ \` / __ \`/ _ \\/ ___/${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}/ /_/ /| |/ / /  / / /_/ / / / / /_/ / /_/ /  __/ /    ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}\\____/ |___/_/  /_/\\__,_/_/ /_/\\__,_/\\__, /\\___/_/     ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}  ${WHITE}${BOLD}                                    /____/             ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|${R}                                                           ${BLUE}|${R}"
