...
banner() {
    ...
    echo -e "  ${BLUE}+-----------------------------------------------------+${R}"
    echo -e "  ${BLUE}|                                                     ${BLUE}${R}|"
    echo -e "  ${BLUE}|  ${RED}${BOLD}_____   ____  __                               ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|  ${RED}${BOLD} / _ \\\\ \\\\ / /  \\\\/  |__ _ _ _  __ _ __ _ ___ _ _ ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|  ${RED}${BOLD}| (_) \\\\ V /| |\\\\/| / _\` | ' \\\\/ _\` / _\` / -_) '_|${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|  ${RED}${BOLD} \\\\___/ \\\\_/ |_|  |_\\\\__,_|_||_\\\\__,_\\\\__, \\\\___|_|  ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|  ${RED}${BOLD}                                 |___/         ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|                                                     ${BLUE}${R}|"
    echo -e "  ${BLUE}|  ${DIM}OpenVPN Panel  ·  Free & Open Source  ·  v1.5  ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|  ${DIM}https://github.com/anonysec/OVManager          ${R}  ${BLUE}|${R}"
    echo -e "  ${BLUE}|                                                     ${BLUE}${R}|"
    echo -e "  ${BLUE}+-----------------------------------------------------+${R}"
    echo -e ""
}
