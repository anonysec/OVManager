...
Version reset: pre-publish cleanup. History was rewritten to a single identity, all prior releases/tags removed, numbering restarted at 1.0.0. Installer-harmony work lands on `dev` before the first public release.
